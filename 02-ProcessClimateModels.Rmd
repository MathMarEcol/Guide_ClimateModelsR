...
This "regridding process" works fine if you have one or two **netCDF** files. However, if you have multiple **netCDF** files/models (which is most cases of CMIP6 models) the best way to do it is to write a *R* script to call CDO through the **system()** function.
...
Some climate models are build across different depths in the ocean. This following code helps to create 
...
Running the ocean depth layer R function
